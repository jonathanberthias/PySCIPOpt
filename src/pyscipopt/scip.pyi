# This file was generated by stubgen-pyx v0.2.9 from src/pyscipopt/scip.pyx
...
class Model:
    ...
    def includeProp(self, prop: Prop, name, desc, presolpriority, presolmaxrounds, proptiming, presoltiming=..., priority=1, freq=1, delay=True):
        """
    ...
    def includeHeur(self, heur: Heur, name, desc, dispchar, priority=10000, freq=1, freqofs=0, maxdepth=-1, timingmask=..., usessubscip=False):
        """
...
StageNames = {}
EventNames = {}
SCIP_RETCODE: _TypeAlias = int
SCIP_VARTYPE: _TypeAlias = int
SCIP_VARSTATUS: _TypeAlias = int
SCIP_OBJSENSE: _TypeAlias = int
SCIP_OBJSEN: _TypeAlias = int
SCIP_BOUNDTYPE: _TypeAlias = int
SCIP_RESULT: _TypeAlias = int
SCIP_STATUS: _TypeAlias = int
SCIP_STAGE: _TypeAlias = int
SCIP_NODETYPE: _TypeAlias = int
SCIP_PARAMSETTING: _TypeAlias = int
SCIP_PARAMTYPE: _TypeAlias = int
SCIP_PARAMEMPHASIS: _TypeAlias = int
SCIP_PROPTIMING: _TypeAlias = int
SCIP_PRESOLTIMING: _TypeAlias = int
SCIP_HEURTIMING: _TypeAlias = int
SCIP_EXPR: _TypeAlias = int
SCIP_BASESTAT: _TypeAlias = int
SCIP_LPPARAM: _TypeAlias = int
SCIP_EVENTTYPE: _TypeAlias = int
SCIP_LPSOLQUALITY: _TypeAlias = int
SCIP_LOCKTYPE: _TypeAlias = int
SCIP_IMPLINTTYPE: _TypeAlias = int
SCIP_BENDERSENFOTYPE: _TypeAlias = int
SCIP_LPSOLSTAT: _TypeAlias = int
SCIP_BRANCHDIR: _TypeAlias = int
SCIP_BOUNDCHGTYPE: _TypeAlias = int
SCIP_ROWORIGINTYPE: _TypeAlias = int
SCIP_SOLORIGIN: _TypeAlias = int
SCIP_Bool: _TypeAlias = bool
SCIP_Longint: _TypeAlias = int
SCIP_Real: _TypeAlias = float
